...
public class ScoreAndParkLeft extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory parkingZoneOne = drive.trajectoryBuilder(leaveJunction.end())
                .lineTo(new Vector2d(-60, -35))
                .build();

       /* Trajectory parkingZoneTwo = drive.trajectoryBuilder(leaveJunction.end())
                .lineTo(new Vector2d(-35, -35))
                .build();*/

        Trajectory parkingZoneThree = drive.trajectoryBuilder(leaveJunction.end())
        ...
        while (intake < 1){
            ...
            if (limitSwitch.getState() == false){
                ...
                if (targetElevatorPosition >= 3930 && targetElevatorPosition <= 3990){
                    intake = intake + 1;
                }
            }
