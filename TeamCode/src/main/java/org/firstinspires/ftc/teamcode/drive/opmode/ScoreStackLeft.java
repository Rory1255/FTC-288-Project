...
@Autonomous(name = "Score From Stack Left")
public class ScoreStackLeft extends LinearOpMode {
    ...
    final double FIVE_STACK_HEIGHT = 704;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence stackForward = drive.trajectorySequenceBuilder( colorAdjustLeft.end())
                .waitSeconds(0.3)
      ...
      /*  TrajectorySequence realignWithStack = drive.trajectorySequenceBuilder(leaveStackOrJunction.end())
        ...
        if (leftBlueValue > 220 && rightBlueValue < 220){
            drive.followTrajectorySequence(colorAdjustRight);
        }
        if (leftBlueValue < 220 && rightBlueValue > 220){
            drive.followTrajectorySequence(colorAdjustLeft);
